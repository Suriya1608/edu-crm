                    ...
                    <div className="timeline-item" key={activity.id} data-type={activity.type}>
                        <div className="timeline-icon">
                            <span className="material-icons">
                                {ACTIVITY_ICON[activity.type] || 'info'}
                            </span>
                        </div>
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    ...
                    <div className="modal-footer">
                        <button type="button" className="btn btn-secondary" onClick={step === 'confirm' ? () => setStep('pick') : onClose}>
                            {step === 'confirm' ? 'Back' : 'Cancel'}
                        </button>
                        <button type="button" className={`btn ${step === 'confirm' ? 'btn-warning' : 'btn-primary'}`}
...
function CallOutcomeModal({ show, url, onClose, onLogged }) {
    ...
    return (
        <div className="modal fade show d-block" tabIndex="-1" style={{ backgroundColor:'rgba(0,0,0,.5)' }} data-bs-backdrop="static">
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    ...
                    <div className="modal-footer border-0 pt-0">
                        <button type="button" className="btn btn-link text-muted btn-sm" onClick={onClose}>
                            Skip
                        </button>
                    </div>
                </div>
...
// ─── Main Contact Page ────────────────────────────────────────────────────────
export default function Contact({ campaign, contact: initialContact, activities: initialActivities, whatsapp_messages, urls }) {
    ...
    function handleOutcomeLogged(outcome) {
        const statusMap = { interested:'interested', not_interested:'not_interested', callback:'callback', no_answer:'no_answer', called:'called' };
    ...
    // Listen for global TCN call-ended event
    useEffect(() => {
        const handler = () => handleCallEnded();
                ...
                <div className="row g-4">
                    ...
                    <div className="col-lg-8">
                        ...
                        <div className="action-bar mb-4">
                            <button type="button" className="btn btn-primary call-btn"
                            ...
                            <button className="btn btn-success" type="button"
                                onClick={() => {
                                    const el = document.querySelector('.wa-chat-body');
