...
function ProfileCard({ lead, telecallers, assignUrl }) {
    ...
    function handleDateChange(e) {
        ...
        // Clear telecaller selection if they are now unavailable on the new date
                    ...
                    <div className="flex-grow-1">
                        ...
                        <form onSubmit={submit}>
                            ...
                            <input
                                ...
                                value={form.data.assignment_date}
                                min={today}
                            ...
                            {availableTelecallers.length === 0 && (
                                <p style={{ fontSize: 11, color: '#ef4444', margin: '2px 0 6px' }}>
                                    No telecallers available on this date.
                                </p>
                            )}
                            {hiddenCount > 0 && (
                                <p style={{ fontSize: 11, color: '#f59e0b', margin: '2px 0 6px' }}>
                                    {hiddenCount} telecaller{hiddenCount > 1 ? 's' : ''} unavailable on this date.
                                </p>
                            )}
                            <button className="btn btn-sm btn-primary w-100 mt-1" disabled={form.processing}>
...
const STATUS_OPTIONS_MGR = [
    { value: 'new',            label: 'New',           icon: 'fiber_new',     bg: '#64748b' },
    { value: 'assigned',       label: 'Assigned',      icon: 'person_add',    bg: '#6366f1' },
