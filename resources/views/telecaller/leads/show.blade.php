...
@section('content')
    ...
    <div class="lead-profile-nav">
        <div class="d-flex justify-content-between align-items-center w-100">
            <div class="d-flex align-items-center gap-3">
                <a href="{{ route('telecaller.leads') }}" class="btn btn-sm btn-light">
                    <span class="material-icons me-1" style="font-size: 18px;">arrow_back</span>
                    Back to Leads
                </a>
                <div>
                    <h2 class="page-header-title mb-0">Lead Profile</h2>
                    <p class="page-header-subtitle mb-0">Complete details and activity timeline</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="profile-card mb-4">
                    <div class="profile-header">
                        <div class="profile-info">
                            ...
                            <span class="status-badge hot-lead">{{ strtoupper($lead->status) }}</span>
                            <p class="profile-id">ID: {{ $lead->lead_code }}</p>
                        </div>
                    </div>
                    ...
                    <div class="profile-details">
                        ...
                        <div class="detail-item">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="detail-value">{{ $lead->course ?? '-' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="detail-item">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="detail-value text-success">{{ $lead->assignedBy->name ?? '-' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        (function () {
            ...
            // ── Track highest rendered message ID ──────────────
            let lastMsgId = 0;
    ...
    <script>
        (function() {
            ...
            statusSelect?.addEventListener('change', function() {
                var followupSection = document.getElementById('followupFields');
                followupSection.style.display = this.value === 'follow_up' ? 'block' : 'none';
                // Reset confirmation state on change
            ...
            confirmBtn?.addEventListener('click', function() {
                ...
                var current = @json(ucfirst(str_replace('_', ' ', $lead->status)));
