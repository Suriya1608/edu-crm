    ...
    <div class="lead-profile-nav">
        <div class="d-flex justify-content-between align-items-center w-100">
            <div class="d-flex align-items-center gap-3">
                <a href="{{ route('telecaller.campaigns.show', encrypt($campaign->id)) }}" class="btn btn-sm btn-light">
                    ...
                    <div class="timeline-content">
                        ...
                        @empty
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted mt-2">No activity recorded yet. Make your first call.</p>
                            </div>
                        @endforelse
                    </div>
                </div>
        ...
        (function () {
            ...
            document.querySelectorAll('.outcome-btn').forEach(function (btn) {
                btn.addEventListener('click', async function () {
                    ...
                    // Also update contact status to match outcome
                    const statusMap = {
