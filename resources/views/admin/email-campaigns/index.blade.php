    ...
    <div class="chart-card">
        @if ($campaigns->isEmpty())
            <div class="text-center py-5 text-muted">
                ...
                <a href="{{ route('admin.email-campaigns.create') }}" class="btn btn-primary btn-sm mt-1">Create First Campaign</a>
            </div>
        @else
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        @foreach ($campaigns as $ec)
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('admin.email-campaigns.show', $ec->id) }}"
                                ...
                                <td class="text-muted" style="font-size:13px;">{{ $ec->creator?->name ?? '—' }}</td>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        ...
                                        <form action="{{ route('admin.email-campaigns.destroy', $ec->id) }}"
                                            method="POST"
