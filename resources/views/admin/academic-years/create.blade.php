        ...
        <form action="{{ route('admin.academic-years.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                    value="{{ old('name') }}" placeholder="e.g. 2026-27" style="max-width:180px;">
            ...
            <div class="mb-4">
                <div class="form-check form-switch">
                    ...
                    <label class="form-check-label fw-semibold" for="isActive">Set as Active Year</label>
                </div>
                <div class="form-text">Only one year can be active. Enabling this will deactivate the current active year.</div>
            </div>

            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <span class="material-icons me-1" style="font-size:16px;">save</span>Save
                </button>
